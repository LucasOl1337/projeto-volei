# 0006 - Plano, evolucao e video manual
...
- `Plano de treino` ganhou um roteiro de sessao em casa com quatro passos: preparar espaco, aquecer fundamento, serie principal e fechar registro.
- `Evolucao` ganhou criterios manuais comparaveis: controle, tecnica e consistencia.
- `Videos` passou a mostrar uma linha do tempo manual, marcadores tecnicos e uma ficha de evidencia.
- Filtros de treino e exercicios agora informam estado com `aria-pressed`.
